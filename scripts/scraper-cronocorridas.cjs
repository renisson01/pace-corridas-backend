#!/usr/bin/env node
/**
 * REGENI — Scraper CronoCorridas (Wiclax CLAX/XML)
 * cronocorridas.com.br — São Paulo / Interior SP
 * 57 eventos disponíveis
 *
 * Uso:
...
const BASE        = 'https://cronocorridas.com.br/resultados/';
const LISTING_URL = 'https://cronocorridas.com.br/resultados-eventos';
const ORGANIZER   = 'CronoCorridas';
...
function get(url, depth = 0) {
  return new Promise((resolve, reject) => {
    ...
    const req = lib.get(url, {
      headers: { 'User-Agent': 'Mozilla/5.0 Chrome/120', 'Accept': '*/*', 'Referer': 'https://cronocorridas.com.br/' },
      timeout: 30000,
    }, res => {
