...
const BASE = 'https://www.sportschrono.com.br/resultados';
const DELAY = ms => new Promise(r => setTimeout(r, ms));

// Lista de eventos CLAX do SportsChrono
const EVENTOS = [
  'evento/2026/VERAO-SERGIPE-ETAPA-ARACAJU/VERAO-SERGIPE-ETAPA-ARACAJU.clax',
  'evento/2026/CORRIDA-DA-AMIZADE-9-EDICAO/CORRIDA-DA-AMIZADE-9-EDICAO.clax',
  'evento/2026/CORRIDA-UCP-ENERGY-RUN/CORRIDA-UCP-ENERGY-RUN.clax',
  'evento/2026/CAMPEONATO-SERGIPANO-FESTRI-DUATLO/CAMPEONATO-SERGIPANO-FESTRI-DUATLO.clax',
  'evento/2025/CORRIDA-DA-PAZ-2025/CORRIDA-DA-PAZ-2025.clax',
  'evento/2025/II-CORRIDA-SUPERE-SE/II-CORRIDA-SUPERE-SE.clax',
  'evento/2025/MACAMBIRA-SUNSET-2025/MACAMBIRA-SUNSET-2025.clax',
  'evento/2025/MIABA-RUN/MIABA-RUN.clax',
  'evento/2025/1-CORRIDA-DO-EMPREENDEDOR/1-CORRIDA-DO-EMPREENDEDOR.clax',
  'evento/2025/1-CORRIDA-GUARDIOES-DO-BAIXO-SAO-FRANCISCO/1-CORRIDA-GUARDIOES-DO-BAIXO-SAO-FRANCISCO.clax',
  'evento/2025/1-CORRIDA-DE-NEOPOLIS/1-CORRIDA-DE-NEOPOLIS.clax',
  'evento/2025/5-CORRIDA-DA-AACC/5-CORRIDA-DA-AACC.clax',
  'evento/2025/CORRIDA-DO-BARCO-DE-FOGO-2025/CORRIDA-DO-BARCO-DE-FOGO-2025.clax',
  'evento/2025/CORRIDA-EU-AMO-SOCORRO-2025/CORRIDA-EU-AMO-SOCORRO-2025.clax',
  'evento/2025/CORRIDA-EASY-RUN/CORRIDA-EASY-RUN.clax',
  'evento/2025/BRITO-RIDE-III/BRITO-RIDE-III.clax',
  'evento/2025/JET-CORRIDA-2025/JET-CORRIDA-2025.clax',
  'evento/2025/CIRCUITO-ZODIACO-ETAPA-AR/CIRCUITO-ZODIACO-ETAPA-AR.clax',
  'evento/2025/CORRIDA-ESPLENDIDA-EXPERIENCE/CORRIDA-ESPLENDIDA-EXPERIENCE.clax',
  'evento/2025/3-CORRIDA-SOLIDARIA-3BPM/3-CORRIDA-SOLIDARIA-3BPM.clax',
  'evento/2025/3-CORRIDA-DA-BARRAGEM/3-CORRIDA-DA-BARRAGEM.clax',
  'evento/2024/CORRIDA-DA-AMIZADE-2024/CORRIDA-DA-AMIZADE-2024.clax',
  'evento/2024/CORRIDA-DA-PAZ-2024/CORRIDA-DA-PAZ-2024.clax',
  'evento/2024/CORRIDA-DA-AACC-2024/CORRIDA-DA-AACC-2024.clax',
  'evento/2024/CORRIDA-DO-BARCO-DE-FOGO-2024/CORRIDA-DO-BARCO-DE-FOGO-2024.clax',
  'evento/2024/CORRIDA-SOLDADO-CIDADAO-2024/CORRIDA-SOLDADO-CIDADAO-2024.clax',
  'evento/2024/CORRIDA-EU-AMO-SOCORRO-2024/CORRIDA-EU-AMO-SOCORRO-2024.clax',
  'evento/2024/3-CORRIDA-DA-BARRAGEM/3-CORRIDA-DA-BARRAGEM.clax',
  'evento/2023/CORRIDA-DA-AMIZADE-2023/CORRIDA-DA-AMIZADE-2023.clax',
  'evento/2023/CORRIDA-DA-PAZ-2023/CORRIDA-DA-PAZ-2023.clax',
];
